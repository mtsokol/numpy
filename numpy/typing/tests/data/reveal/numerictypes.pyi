...
assert_type(np.cast[int], np._core.numerictypes._CastFunc)
assert_type(np.cast["i8"], np._core.numerictypes._CastFunc)
assert_type(np.cast[np.int64], np._core.numerictypes._CastFunc)
